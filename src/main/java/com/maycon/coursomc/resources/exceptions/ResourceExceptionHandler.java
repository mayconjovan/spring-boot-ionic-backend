package com.maycon.coursomc.resources.exceptions;
...
import com.maycon.coursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request){
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Deniend access", e.getMessage(), request.getRequestURI());
