...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()				
				.apis(RequestHandlerSelectors.basePackage("com.maycon.coursomc.resources")).paths(PathSelectors.any())
				.build()
				.apiInfo(apiInfo());
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				"",
				new Contact("Maycon J Pereira", "https://www.linkedin.com/in/maycon-jovan-pereira-8a0299113/", "mayconjovan@gmail.com"),
				"Permitido uso para estudantes", "", Collections.emptyList() // Vendor
																										// Extensions
		);
	}
